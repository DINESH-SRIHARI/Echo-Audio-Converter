...
__all__ = [
    'SPSHORTCUTTYPE', 'ISpMMSysAudio', 'eLEXTYPE_PRIVATE2',
    'SPAS_CLOSED', 'DISPID_SpeechPhraseAlternates',
    'ISpeechPhraseElements', 'SAFTText', 'SWTDeleted',
    'STSF_CommonAppData', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechPhraseRule', 'DISPID_SVAudioOutputStream',
    'SpeechGrammarTagDictation', 'SGSDisabled',
    'DISPID_SGRSTransitions', 'DISPID_SPCPhoneToId', 'SpFileStream',
    'DISPID_SVStatus', 'DISPID_SpeechAudio', 'SAFT16kHz16BitMono',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechObjectToken',
    'SpMMAudioOut', 'DISPID_SPPsItem', 'SpeechWordType',
    'IInternetSecurityManager', 'tagSPTEXTSELECTIONINFO',
    'ISpeechObjectTokenCategory', 'SPEI_UNDEFINED',
    'SPEI_INTERFERENCE', 'SpeechVoiceEvents',
    'DISPID_SRGCmdLoadFromObject', 'SPCT_DICTATION', 'SPEVENTENUM',
    'SAFTCCITT_ALaw_8kHzMono', 'SpObjectTokenCategory',
    'ISpeechFileStream', 'DISPID_SVDisplayUI',
    'DISPID_SPISaveToMemory', 'SGRSTTWord', 'DISPID_SMSALineId',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRCEFalseRecognition',
    'ISpRecoGrammar', 'SPSUnknown', 'SpeechStreamSeekPositionType',
    'SREStateChange', 'SDTAlternates', 'SRCS_Enabled', 'SLTUser',
    'SITooSlow', 'SSTTDictation', 'SVP_20', 'DISPID_SVSpeak',
    'SPWT_LEXICAL', 'DISPID_SRCERecognizerStateChange',
    'SAFT32kHz16BitMono', 'SGRSTTWildcard', 'WAVEFORMATEX',
    'ISpeechLexiconWord', 'DISPID_SGRSTRule',
    'DISPID_SPIReplacements', 'SAFT16kHz16BitStereo',
    'DISPID_SDKSetLongValue', 'DISPID_SVEViseme',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPIProperties', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechGrammarRuleStateTransition', 'SpeechUserTraining',
    'DISPID_SLWLangId', 'SLODynamic',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPRuleName',
    'ISpStreamFormat', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRRTLength', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SASNonBlockingIO', 'SPPHRASEREPLACEMENT', 'ISpDataKey',
    'SDTReplacement', 'DISPID_SLPs_NewEnum', 'DISPID_SPARecoResult',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechPhoneConverter',
    'DISPID_SWFEExtraData', 'DISPID_SPIAudioSizeTime',
    'DISPID_SGRsAdd', 'SPEI_REQUEST_UI', 'DISPID_SVVolume',
    'DISPID_SLAddPronunciationByPhoneIds', 'LONG_PTR',
    'DISPID_SBSWrite', 'SPEI_RESERVED3', 'DISPID_SVEPhoneme',
    'SPSSuppressWord', 'SAFT16kHz8BitMono',
    'DISPID_SRSetPropertyString', 'SPSEMANTICFORMAT', 'ISpAudio',
    'ISpRecoContext2', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechDisplayAttributes', 'DISPID_SABufferInfo', 'SGSEnabled',
    'DISPID_SRCRetainedAudio', 'SVP_2', 'SDA_No_Trailing_Space',
    'ISpeechPhraseElement', 'SGRSTTDictation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_0',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SASPause',
    'DISPID_SOTMatchesAttributes', 'ISpObjectToken',
    'DISPID_SGRAddState', 'SPPS_RESERVED1', 'DISPID_SPIStartTime',
    'DISPID_SMSAMMHandle', 'eLEXTYPE_PRIVATE9', 'DISPID_SOTCategory',
    'SSSPTRelativeToCurrentPosition', 'SVEAudioLevel',
    'ISpeechAudioStatus', 'SPEI_MIN_SR',
    'DISPID_SPIAudioStreamPosition', 'ISpeechVoiceStatus',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechRecoResult2', 'SAFTCCITT_ALaw_22kHzMono',
    '_SPAUDIOSTATE', 'eLEXTYPE_PRIVATE11', 'SAFT12kHz16BitStereo',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechBaseStream', 'SRTStandard',
    'DISPID_SBSSeek', 'DISPID_SRSSupportedLanguages', 'SVF_Emphasis',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRCEPropertyStringChange',
    'SSTTWildcard', 'SpeechEngineConfidence',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechLoadOption', 'SINoSignal', 'DISPID_SVWaitUntilDone',
    'SVP_18', 'SPSHT_NotOverriden', 'ISequentialStream',
    'DISPID_SVSCurrentStreamNumber', 'SAFT44kHz16BitStereo',
    'SGLexicalNoSpecialChars', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechFileStream', 'SASStop', 'SPEI_MIN_TTS',
    'eLEXTYPE_PRIVATE8', 'SAFTCCITT_ALaw_8kHzStereo',
    'SVEVoiceChange', 'DISPID_SWFEBitsPerSample', 'SP_VISEME_13',
    'SP_VISEME_16', 'DISPID_SBSFormat', 'DISPID_SLGenerationId',
    'DISPID_SRCCmdMaxAlternates', 'SREPhraseStart', 'SPWF_SRENGINE',
    'SpeechDiscardType', 'DISPID_SPERetainedSizeBytes',
    'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_12', 'DISPID_SWFEChannels',
    'DISPID_SPAPhraseInfo', 'SPSMF_UPS', 'DISPID_SOTGetAttribute',
    'SP_VISEME_3', 'SpMemoryStream', 'SpeechInterference',
    'SpeechCategoryRecoProfiles', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_PRIVATE6',
    'DISPID_SDKCreateKey', 'DISPID_SpeechAudioStatus',
    'DISPID_SPILanguageId', 'SDA_Two_Trailing_Spaces',
    'SPGRAMMARSTATE', 'SpUnCompressedLexicon', 'DISPID_SOTCSetId',
    'SPFM_NUM_MODES', 'DISPID_SVAudioOutput', 'SVP_15',
    'DISPID_SDKGetBinaryValue', 'DISPID_SRGetRecognizers',
    'DISPID_SRRGetXMLResult', 'SINone', 'SP_VISEME_17',
    'SpeechCategoryPhoneConverters', 'ISpeechAudioFormat',
    'SGDSInactive', 'STSF_LocalAppData', 'DISPID_SRCEHypothesis',
    'DISPID_SGRSTsCount', 'SpeechCategoryAppLexicons',
    'SPVPRI_NORMAL', 'SP_VISEME_10', 'DISPID_SMSADeviceId',
    'SRTExtendableParse', 'DISPID_SPCIdToPhone',
    'SWPUnknownWordUnpronounceable',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPPName',
    'ISpeechLexiconWords', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRDisplayUI', 'DISPID_SRSClsidEngine',
    'SPDATAKEYLOCATION', 'SVSFIsFilename', 'SPINTERFERENCE',
    'SpeechRecognizerState', 'DISPID_SPRNumberOfElements',
    'SpeechFormatType', 'DISPID_SVGetVoices',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SOTGetDescription',
    'SPEI_VOICE_CHANGE', 'SPLO_DYNAMIC', 'DISPID_SRGDictationLoad',
    'DISPID_SpeechPhraseAlternate', 'SpeechCategoryRecognizers',
    'SVSFPersistXML', 'DISPID_SPRuleId', 'SPEI_SOUND_START',
    'ISpPhoneticAlphabetConverter', 'SPGRAMMARWORDTYPE',
    'DISPID_SRGCmdSetRuleState', 'SpMMAudioIn',
    'DISPID_SPRules_NewEnum', 'DISPID_SGRSTType', 'ISpeechRecoResult',
    'SPWORDTYPE', 'SPSInterjection', 'SECFIgnoreCase',
    'SAFTADPCM_22kHzMono', 'eLEXTYPE_PRIVATE5', 'DISPID_SMSSetData',
    'SPCS_DISABLED', 'STCInprocHandler', 'SPEI_RECOGNITION',
    'DISPID_SRGDictationUnload', 'ISpNotifySource', 'ISpPhraseAlt',
    'SP_VISEME_2', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPRs_NewEnum', 'DISPID_SVSkip', 'SPEI_END_SR_STREAM',
    'SITooFast', 'SVEWordBoundary', 'DISPID_SRRTStreamTime',
    'DISPID_SVSInputWordLength', 'SRSInactive',
    'SPEI_SENTENCE_BOUNDARY', 'SP_VISEME_19', 'SAFTDefault',
    ...
    'DISPID_SRCSetAdaptationData', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPEsCount',
    'SpResourceManager', 'SpeechGrammarState', 'SVEEndInputStream',
    'SECFEmulateResult', 'DISPID_SAFType', 'SGDSActive',
    'SPPS_Noncontent', 'SSFMCreate', 'ISpRecoResult',
    'SAFT11kHz16BitStereo', 'SPTEXTSELECTIONINFO', 'DISPID_SGRsItem',
    'DISPID_SPRuleParent', 'DISPID_SpeechLexicon',
    'SpeechRecognitionType', 'SECHighConfidence',
    'ISpeechRecoResultTimes', 'ISpeechRecoGrammar',
    'DISPID_SPEAudioStreamOffset', 'SpeechAudioFormatGUIDText',
    'DISPID_SOTDisplayUI', 'DISPID_SWFEFormatTag',
    'SpStreamFormatConverter', 'SpeechLexiconType',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPRDisplayAttributes',
    'SPGS_DISABLED', 'SP_VISEME_11', 'SpeechPropertyAdaptationOn',
    'SAFTCCITT_ALaw_44kHzMono', 'SPPARTOFSPEECH',
    'SpNullPhoneConverter', 'SVP_1', 'SPPROPERTYINFO',
    'DISPID_SPERequiredConfidence', 'ISpeechPhraseInfo',
    'SPFM_CREATE_ALWAYS', 'DISPID_SOTCGetDataKey', 'SPEI_RESERVED1',
    'DISPID_SOTs_NewEnum', 'SPSEMANTICERRORINFO', 'SVP_5',
    'ISpRecognizer3',
    ...
    'ISpeechGrammarRules', 'SPRST_NUM_STATES', 'SAFTADPCM_44kHzMono',
    'SAFT16kHz8BitStereo', 'DISPID_SRRSetTextFeedback',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRRAudio', 'SPXMLRESULTOPTIONS', 'DISPID_SPAsCount',
    'SPVOICESTATUS', 'SGSExclusive', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRSNumberOfActiveRules', 'SVSFParseMask',
    'ISpeechPhraseReplacements', 'SVSFUnusedFlags',
    'DISPID_SRCEAdaptation', 'SLTApp', 'DISPID_SRCBookmark',
    'ISpRecoContext', 'eLEXTYPE_PRIVATE1', 'SREPropertyStringChange',
    'SAFT32kHz8BitStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    ...
    'SpStream', 'SPSERIALIZEDPHRASE', 'SDKLCurrentConfig',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechBaseStream',
    'ISpProperties', 'SVSFNLPMask', 'SpeechWordPronounceable',
    'DISPID_SOTCreateInstance', 'DISPID_SVRate',
    'DISPID_SCSBaseStream', 'SpVoice', 'DISPID_SRCEBookmark',
    'SVP_14', 'DISPID_SDKEnumKeys',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRCreateRecoContext', 'DISPID_SpeechXMLRecoResult',
    'SAFT8kHz8BitMono', 'SPEI_RESERVED5', 'SAFT12kHz8BitStereo',
    'SVSFIsXML', 'DISPID_SGRInitialState', 'eLEXTYPE_PRIVATE10',
    'SREStreamEnd', 'SPEI_SR_PRIVATE', 'DISPID_SRProfile',
    'ISpeechDataKey', 'DISPID_SpeechVoice', 'Speech_StreamPos_Asap',
    'DISPID_SVEStreamStart', 'DISPID_SRGDictationSetState',
    'SPAUDIOOPTIONS', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPLOADOPTIONS', 'ISpRecoGrammar2', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SVSVisemeId', 'DISPID_SGRSAddWordTransition',
    'eLEXTYPE_USER_SHORTCUT', 'SREFalseRecognition',
    'ISpeechCustomStream', 'DISPID_SPIRule', 'ISpeechPhraseProperty',
    'DISPID_SRCESoundEnd', 'SPGS_ENABLED', 'SAFT48kHz16BitStereo',
    'DISPID_SRRSaveToMemory', 'SAFT24kHz8BitMono',
    'ISpObjectTokenCategory', 'DISPID_SGRAddResource',
    'ISpeechPhraseReplacement', 'SBONone', 'SRAInterpreter',
    'SLOStatic', 'SVP_8', 'SPINTERFERENCE_NONE', 'SpObjectToken',
    'SPPS_RESERVED2', 'SpeechPropertyResourceUsage',
    'DISPID_SVSInputSentenceLength', 'SPSNoun',
    'SAFTGSM610_44kHzMono', 'SPWT_DISPLAY', 'SPBO_NONE',
    'DISPID_SAVolume', 'SPAR_Medium', 'SpeechTokenShellFolder',
    'ISpeechRecoContext', 'SpeechEngineProperties', 'SVP_3',
    'DISPID_SPPFirstElement', 'ISpeechPhraseAlternate',
    'ISpeechRecoResult2', 'SASRun', 'ISpRecoCategory',
    '_ISpeechVoiceEvents', 'SpeechDataKeyLocation',
    'SPDKL_DefaultLocation', 'DISPID_SRGetFormat',
    'DISPID_SRGCmdLoadFromMemory', 'SP_VISEME_20',
    'eLEXTYPE_RESERVED7', 'DISPID_SPPChildren', 'SP_VISEME_21',
    'SpeechRegistryUserRoot', 'DISPID_SPIGetDisplayAttributes',
    'eLEXTYPE_APP', 'DISPID_SRRTimes', 'SPEI_START_INPUT_STREAM',
    'eWORDTYPE_ADDED', 'SPEI_TTS_BOOKMARK', 'SPWF_INPUT',
    'DISPID_SGRAttributes', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SVEViseme', 'SPVPRIORITY', 'SAFTGSM610_8kHzMono', 'SPRST_ACTIVE',
    'DISPID_SRIsUISupported', 'DISPID_SGRsFindRule',
    'SpPhoneConverter', 'DISPID_SPIElements',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRGCommit',
    'SSFMOpenReadWrite', 'DISPID_SPPsCount',
    'DISPID_SpeechGrammarRules', 'SVP_10', 'SVP_9',
    'SAFT48kHz16BitMono', 'DISPID_SPRsItem', 'SAFT24kHz16BitMono',
    'SPWORDPRONUNCIATION', 'DISPID_SVEEnginePrivate',
    'DISPID_SPRuleChildren', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SLWsItem', 'SPEI_PROPERTY_STRING_CHANGE',
    'SGDSActiveWithAutoPause', 'DISPID_SREmulateRecognition',
    'SPCT_SUB_DICTATION', 'DISPID_SRRGetXMLErrorInfo', 'SVP_12',
    'DISPID_SPIGetText', 'SpeechRuleAttributes',
    'DISPID_SLRemovePronunciation', 'DISPID_SABIMinNotification',
    'SAFTADPCM_44kHzStereo', 'IEnumSpObjectTokens',
    'SPWORDPRONOUNCEABLE', 'DISPID_SVResume', 'SAFT11kHz16BitMono',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SGRSRule',
    'SPEI_RESERVED6', 'DISPID_SOTGetStorageFileName', 'SPVPRI_ALERT',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'eWORDTYPE_DELETED',
    'SRAExport', 'SPPS_RESERVED3', 'SDA_Consume_Leading_Spaces',
    'SpCustomStream', 'DISPID_SRSAudioStatus',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPEsItem', 'DISPID_SDKDeleteValue', 'STCLocalServer',
    ...
    'DISPID_SRCEPropertyNumberChange', 'eLEXTYPE_PRIVATE16',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SDKDeleteKey',
    'DISPID_SRGReset', 'ISpeechPhraseAlternates', 'SPSHT_EMAIL',
    'DISPID_SPRulesItem', 'ISpPhrase',
    'DISPID_SPRuleNumberOfElements', 'SPRULE', 'SVP_6', 'SDTAll',
    'SPRECOGNIZERSTATUS', 'SECNormalConfidence', 'SPEI_TTS_PRIVATE',
    'SPSTREAMFORMATTYPE', 'SAFTADPCM_22kHzStereo',
    'SPPS_Interjection', 'eLEXTYPE_PRIVATE19', 'DISPID_SGRSTsItem',
    'SpeechTokenValueCLSID', 'DISPID_SPPs_NewEnum', 'SpMMAudioEnum',
    'SVEAllEvents', 'SSFMCreateForWrite', 'DISPID_SLWWord',
    'DISPID_SPPEngineConfidence', 'SRTAutopause', 'SPPS_Function',
    'SpeechVoiceSkipTypeSentence', 'STSF_FlagCreate', 'SPEI_VISEME',
    'SAFT44kHz8BitMono', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SGRId', 'DISPID_SLPLangId', 'SAFTCCITT_uLaw_44kHzMono',
    'SPAUDIOBUFFERINFO', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpPhraseInfoBuilder', 'SPAR_High', 'SAFT22kHz8BitStereo',
    'DISPID_SRRDiscardResultInfo', 'eLEXTYPE_PRIVATE18',
    '_RemotableHandle', 'SAFT48kHz8BitMono', 'SPAO_NONE',
    'DISPID_SVSPhonemeId', 'DISPID_SPRuleFirstElement',
    'DISPID_SRCESoundStart', 'SDA_One_Trailing_Space',
    'DISPID_SRAudioInputStream', 'SPSVerb', 'DISPID_SPPConfidence',
    'DISPID_SOTCDefault', 'STCRemoteServer', 'SASClosed',
    'DISPID_SOTSetId', 'DISPID_SpeechCustomStream',
    'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechGrammarRuleStateTransitions', 'SAFTNonStandardFormat',
    'SpeechMicTraining', 'Speech_Default_Weight', 'SVPAlert',
    'DISPID_SRCEStartStream', 'SVEBookmark', 'DISPID_SVVoice',
    'SRAORetainAudio', 'DISPID_SAFGuid', 'DISPID_SPIGrammarId',
    'SVP_7', 'SPLEXICONTYPE', 'SAFTADPCM_11kHzStereo',
    'SPEI_SR_RETAINEDAUDIO', 'SVSFVoiceMask', 'DISPID_SLGetWords',
    'SWPKnownWordPronounceable', 'SPLO_STATIC', 'DISPID_SRAudioInput',
    'DISPID_SpeechLexiconWords', 'DISPID_SASState',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SAFGetWaveFormatEx',
    'SPAR_Unknown', 'SPEI_SOUND_END', 'DISPID_SpeechDataKey',
    'SGDisplay', 'SPRS_ACTIVE', 'DISPID_SRCEEnginePrivate',
    'SRADynamic', 'SAFTExtendedAudioFormat', 'SAFTGSM610_11kHzMono',
    'eLEXTYPE_PRIVATE4', 'DISPID_SpeechLexiconProns', 'ISpeechVoice',
    'SpSharedRecoContext', 'SPEI_START_SR_STREAM',
    'DISPID_SRCRecognizer', 'SVEPhoneme',
    'DISPID_SRCRetainedAudioFormat', 'SPAR_Low', 'DISPID_SPPValue',
    '_ISpeechRecoContextEvents', 'ISpeechWaveFormatEx',
    'STCInprocServer', 'SRTReSent', 'SpCompressedLexicon',
    'SpeechVisemeFeature', 'SRARoot', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPEs_NewEnum', 'ISpResourceManager',
    'SpeechAudioProperties', 'SPSHT_Unknown', 'SPEI_PHONEME',
    'DISPID_SFSClose', 'SpeechTokenIdUserLexicon',
    'DISPID_SPEDisplayText', 'SRCS_Disabled', 'DISPID_SPACommit',
    'SSFMOpenForRead', 'DISPID_SGRsCommitAndSave',
    'DISPID_SLGetGenerationChange', 'SPRULESTATE',
    'SPEI_END_INPUT_STREAM', 'SPWORDLIST', 'SpeechCategoryAudioOut',
    'SRESoundEnd', 'DISPID_SPAs_NewEnum',
    'ISpeechLexiconPronunciations', 'SVF_None', 'SPPHRASERULE',
    'DISPIDSPTSI_SelectionLength', 'ISpeechAudioBufferInfo',
    'DISPID_SGRSTWeight', 'DISPID_SpeechRecoContext',
    'SPINTERFERENCE_TOOQUIET',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPPHRASEELEMENT', 'DISPID_SABIBufferSize',
    'DISPID_SpeechGrammarRuleState', 'SAFT44kHz16BitMono',
    'DISPID_SVPause', 'eLEXTYPE_PRIVATE12',
    'SpeechSpecialTransitionType', 'DISPID_SRRecognizer',
    'eLEXTYPE_PRIVATE20', 'SpInprocRecognizer', 'SDTRule',
    'SP_VISEME_4', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SLPsCount', 'SpeechRuleState', 'SAFT24kHz16BitStereo',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPSLMA', 'DISPID_SRCVoice',
    'SPPS_Unknown', 'DISPID_SPIEnginePrivateData', 'SP_VISEME_15',
    'SAFTADPCM_8kHzMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_FALSE_RECOGNITION', 'ISpObjectWithToken',
    'DISPID_SPIEngineId', 'SpeechRegistryLocalMachineRoot',
    'eLEXTYPE_PRIVATE13', 'ISpNotifySink', 'DISPID_SADefaultFormat',
    'SGRSTTRule', 'DISPID_SPPParent', 'DISPID_SPELexicalForm',
    'SpeechStreamFileMode', 'ISpeechPhraseProperties', 'IEnumString',
    'eLEXTYPE_RESERVED10', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPRsCount', 'SPCONTEXTSTATE', 'DISPID_SRRAlternates',
    'UINT_PTR', 'ISpStream', 'DISPID_SLAddPronunciation',
    'DISPID_SOTDataKey', 'DISPID_SABIEventBias', 'ISpGrammarBuilder',
    'SAFTGSM610_22kHzMono', 'DISPID_SRGState',
    'SPEI_RECO_STATE_CHANGE', 'SpeechCategoryVoices', 'tagSTATSTG',
    'DISPID_SpeechPhraseElement', 'DISPID_SPAsItem',
    'DISPID_SRRRecoContext', 'SREInterference',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPRulesCount',
    ...
    'DISPID_SPRuleEngineConfidence', 'SVP_17', 'ISpeechAudio',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SDKSetStringValue', 'SSTTTextBuffer',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SpeechLexiconWord',
    'SPDKL_CurrentConfig', 'SpeechCategoryAudioIn', 'ISpShortcut',
    'SPPHRASE', 'ISpEventSink', 'DISPID_SLWs_NewEnum', 'SPXRO_SML',
    'SWPUnknownWordPronounceable', 'DISPID_SVSRunningState',
    'SSSPTRelativeToEnd', 'Speech_StreamPos_RealTime',
    'ISpeechPhraseRule', 'SECFIgnoreWidth', 'SRERecoOtherContext',
    'SVP_11', 'SPEI_HYPOTHESIS', 'ISpeechPhraseInfoBuilder',
    'SVSFParseAutodetect', 'SpeechVoiceCategoryTTSRate',
    'SPCS_ENABLED', 'DISPID_SPANumberOfElementsInResult', 'SVP_4',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_USER',
    'DISPID_SDKGetStringValue', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SOTsCount', 'SPEI_MAX_TTS', 'STCAll',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SLPType',
    'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_RESERVED4',
    'SPINTERFERENCE_NOISE', 'DISPID_SRRAudioFormat',
    'DISPID_SGRSTs_NewEnum', 'SPFM_OPEN_READWRITE',
    'DISPID_SRCCreateGrammar',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpeechXMLRecoResult',
    'SPRST_INACTIVE', 'DISPID_SAFSetWaveFormatEx', 'DISPID_SPPId',
    'SRSActive', 'SpeechTokenContext', 'SVEStartInputStream',
    'DISPID_SLWType', 'SECFDefault', 'DISPID_SRCERequestUI',
    'DISPID_SVEWord', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SGRsDynamic', 'DISPID_SGRSTPropertyName',
    'SREStreamStart', 'ISpRecognizer', 'SPPS_NotOverriden',
    'DISPID_SPEDisplayAttributes', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRCState', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SLPPartOfSpeech', 'SREPrivate', 'SAFT8kHz16BitStereo',
    'SREHypothesis', 'SVPNormal', 'SPFILEMODE', 'SRTSMLTimeout',
    'SPAS_STOP', 'SAFTCCITT_uLaw_22kHzStereo', 'SGPronounciation',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRIsShared',
    'ISpeechMemoryStream', 'DISPID_SVAlertBoundary',
    'DISPID_SDKOpenKey', 'DISPID_SRRTTickCount', 'SpWaveFormatEx',
    'SPFM_CREATE', 'DISPID_SWFESamplesPerSec',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCEPhraseStart',
    'SP_VISEME_9', 'SPBO_AHEAD', 'SRAImport', 'SAFT8kHz8BitStereo',
    'SPWORD', 'Speech_Max_Pron_Length', 'SRADefaultToActive',
    'SP_VISEME_14', 'eLEXTYPE_RESERVED6', 'SDTProperty',
    'DISPID_SVEBookmark', 'SAFT32kHz8BitMono', 'SpeechPartOfSpeech',
    'SGRSTTTextBuffer', 'SPSERIALIZEDRESULT', 'DISPID_SVEAudioLevel',
    'SRSInactiveWithPurge', 'ISpXMLRecoResult',
    'SpeechAudioFormatType', 'SPCT_SUB_COMMAND',
    'IInternetSecurityMgrSite', 'SPRS_INACTIVE', 'SpeechAudioVolume',
    'SpeechRecoEvents', 'SDTAudio', 'SPPS_Modifier',
    'SpeechAudioState', 'SWTAdded', 'SpInProcRecoContext',
    'ISpeechLexiconPronunciation', 'DISPID_SRGIsPronounceable',
    'SPEI_SR_BOOKMARK', 'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SOTCId',
    'DISPIDSPRG', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SLPSymbolic', 'ISpeechTextSelectionInformation',
    'SPINTERFERENCE_TOOSLOW', 'SPRECOCONTEXTSTATUS',
    'SAFT22kHz8BitMono', 'DISPID_SRStatus', 'DISPID_SPEPronunciation',
    ...
    'SRSEIsSpeaking', 'DISPID_SVSLastResult', 'DISPID_SOTId',
    'DISPID_SRGId', 'SpeechPropertyComplexResponseSpeed',
    'SAFT48kHz8BitStereo', 'SAFTCCITT_uLaw_8kHzStereo',
    'SDTDisplayText', 'SAFT8kHz16BitMono', 'DISPID_SPRText',
    'SPEI_PHRASE_START', 'SpNotifyTranslator', 'SpShortcut',
    'SpeechRunState', 'SP_VISEME_18', 'SVSFParseSsml',
    'SAFT22kHz16BitStereo', 'DISPID_SOTIsUISupported', 'SVF_Stressed',
    'SPPHRASEPROPERTY', 'DISPID_SpeechRecognizer',
    'SpeechAddRemoveWord', 'DISPID_SRGRecoContext',
    'DISPID_SVGetAudioInputs', 'SpeechRecoContextState',
    'SPBOOKMARKOPTIONS', 'SPBO_PAUSE', 'SpeechBookmarkOptions',
    'DISPID_SLWPronunciations', 'SPWAVEFORMATTYPE',
    'DISPID_SVPriority', 'DISPID_SASetState',
    'DISPID_SRCERecognition', 'SFTInput', 'DISPID_SGRSTPropertyValue',
    'SREBookmark', 'eLEXTYPE_RESERVED8', 'SpeechTokenKeyFiles',
    'eLEXTYPE_PRIVATE14', 'eLEXTYPE_PRIVATE7', 'SPEI_MAX_SR',
    'DISPID_SLPPhoneIds', 'ISpeechPhoneConverter',
    'SpeechDictationTopicSpelling', 'DISPID_SVGetProfiles',
    'SP_VISEME_7', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVPOver',
    'SPGS_EXCLUSIVE', 'DISPID_SGRsCount', 'DISPID_SGRsCommit',
    'ISpVoice', 'ISpEventSource', 'SPDKL_LocalMachine',
    'DISPID_SLWsCount', 'SGRSTTEpsilon', 'SPEI_RESERVED2',
    'SAFTCCITT_uLaw_8kHzMono', 'SITooQuiet', 'SpAudioFormat',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechMemoryStream',
    'DISPID_SRCRequestedUIType', 'ISpeechObjectToken', 'DISPIDSPTSI',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SDKEnumValues', 'SPCT_SLEEP', 'SPBINARYGRAMMAR',
    ...
    'SPAS_RUN', 'ISpPhoneConverter', 'DISPID_SpeechGrammarRule',
    'SBOPause', 'SPPS_LMA', 'eLEXTYPE_PRIVATE3',
    'ISpNotifyTranslator', 'DISPID_SVSInputWordPosition',
    'DISPID_SpeechPhraseRules', 'SDKLLocalMachine', 'SVSFParseSapi',
    'SPPS_Noun', 'DISPID_SOTRemove', 'SVP_16', 'SAFT22kHz16BitMono',
    'DISPID_SBSRead', 'DISPID_SRGCmdLoadFromResource', 'SVP_19',
    'SPWT_PRONUNCIATION', 'eLEXTYPE_LETTERTOSOUND', 'SPSFunction',
    'DISPID_SLGetPronunciations', 'ISpSerializeState', 'SPEVENT',
    'SECLowConfidence', 'DISPID_SRRSpeakAudio', 'IStream',
    'SREAudioLevel', 'SPRECORESULTTIMES', 'SAFTADPCM_8kHzStereo',
    'DISPID_SRCEEndStream', 'DISPID_SGRSTText', 'DISPID_SLPsItem',
    'DISPID_SPRuleConfidence', 'SpeechGrammarWordType',
    'SECFIgnoreKanaType', 'DISPID_SVEVoiceChange',
    'SECFNoSpecialChars', 'SINoise', 'SPAUDIOSTATUS', 'SRESoundStart',
    'SPRST_ACTIVE_ALWAYS', 'SVP_21', 'ISpeechRecognizerStatus',
    'SAFTADPCM_11kHzMono', 'SPFM_OPEN_READONLY',
    'SPINTERFERENCE_TOOLOUD', 'SVSFNLPSpeakPunc', 'SPPS_Verb',
    'DISPID_SPPNumberOfElements', 'SPRECOSTATE', 'SVSFIsNotXML',
    'SPINTERFERENCE_TOOFAST', 'SRERequestUI', 'SpeechVoicePriority',
    'eLEXTYPE_PRIVATE17', 'SPSHT_OTHER', 'SRTEmulated',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechMMSysAudio', 'SVP_13',
    'SP_VISEME_5', 'DISPID_SMSGetData',
    'DISPID_SpeechPhraseReplacement', 'ISpRecognizer2',
    'SAFT11kHz8BitStereo', 'SPEVENTSOURCEINFO', 'SAFT12kHz16BitMono',
    'DISPID_SpeechAudioFormat', 'SpeechTokenKeyAttributes',
    'DISPID_SWFEBlockAlign', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SVSFDefault', 'DISPID_SpeechVoiceStatus', 'SAFT12kHz8BitMono',
    'DISPID_SVEStreamEnd', 'ISpeechObjectTokens', 'SPVPRI_OVER',
    'ISpeechRecognizer', 'DISPID_SVEventInterests',
    'DISPID_SVESentenceBoundary', 'SREPropertyNumChange',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_SR_AUDIO_LEVEL', 'ISpeechResourceLoader', 'SGLexical',
    'SP_VISEME_8', 'SPCATEGORYTYPE', 'SpeechVoiceSpeakFlags',
    'DISPID_SVSpeakStream', 'SDTPronunciation',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SpeechPhraseInfo',
    'SFTSREngine', 'DISPID_SPCLangId', 'SPSHORTCUTPAIR',
    'SPCT_COMMAND', 'DISPID_SRGSetTextSelection', 'SRERecognition',
    'ISpeechGrammarRule', 'SpLexicon', 'DISPID_SGRClear',
    'eLEXTYPE_RESERVED9', '__MIDL_IWinTypes_0009',
    'ISpeechPhraseRules', 'DISPID_SAStatus', 'DISPID_SOTsItem',
    'SAFTNoAssignedFormat', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SREAdaptation', 'ISpeechMMSysAudio', 'ISpeechLexicon',
    'SPADAPTATIONRELEVANCE', 'SRSEDone', 'DISPID_SGRSTPropertyId',
    'SGDSActiveUserDelimited', 'DISPID_SRCEventInterests',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCResume', 'DISPID_SRCPause',
    'DISPID_SRState', 'SP_VISEME_6', 'DISPID_SAEventHandle',
    'SPSModifier', 'SAFTCCITT_uLaw_44kHzStereo', 'SP_VISEME_1',
    'SVEPrivate', 'DISPID_SpeechPhraseElements', 'SRAONone',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRCEAudioLevel',
    'ISpeechGrammarRuleState', 'SPAUDIOSTATE', 'SPVISEMES',
    'SPBO_TIME_UNITS', 'tagSPPROPERTYINFO', 'Speech_Max_Word_Length',
    'SAFT24kHz8BitStereo', 'SVSFlagsAsync',
    'DISPID_SOTCEnumerateTokens', 'SRSActiveAlways',
    'DISPID_SPAStartElementInResult', 'DISPID_SPEEngineConfidence',
    'SAFT11kHz8BitMono', 'SAFT44kHz8BitStereo', 'SpeechTokenKeyUI',
    'ISpLexicon', 'DISPID_SGRName', 'DISPID_SPEAudioSizeTime',
    'SPXRO_Alternates_SML', 'DISPID_SRGRules', 'SPEI_ADAPTATION',
    'SPEI_WORD_BOUNDARY', 'SpeechPropertyResponseSpeed',
    'DISPID_SGRSTNextState', 'SP_VISEME_0',
    'DISPID_SRCAudioInInterferenceStatus', 'SPAS_PAUSE',
    'SVESentenceBoundary', 'SPPS_SuppressWord', 'DISPID_SFSOpen',
    'DISPID_SPEActualConfidence', 'SpeechEmulationCompareFlags',
    'DISPID_SRRPhraseInfo'
]

_check_version('1.2.0', 1698531994.346240)
